...
const recipes = [
  {
    ...
    description: 'A healthy and delicious grilled chicken salad with fresh veggies.',
  },
  {
    id: 2,
    name: 'Quinoa and Black Bean Bowl',
    image: quinoa,
    description: 'A protein-packed quinoa and black bean bowl with a lime dressing.',
  },
  {
    id: 3,
    name: 'Avocado Toast',
    image: avocado,
    description: 'Simple and tasty avocado toast with a sprinkle of chili flakes.',
  },
  {
    id: 4,
    name: 'Berry Smoothie',
    image: berry,
    description: 'A refreshing berry smoothie packed with antioxidants.',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    name: 'Chia Pudding',
    image: chia,
    description: 'A creamy chia pudding with fresh berries and honey.',
  },
  {
    id: 7,
    name: 'Sweet Potato and Black Bean Tacos',
    image: potato,
    description: 'Flavorful sweet potato and black bean tacos with avocado.',
  },
  {
    id: 8,
    name: 'Greek Yogurt Parfait',
    image: yogurt,
    description: 'A light and refreshing Greek yogurt parfait with granola and fruit.',
  },
  {
    id: 9,
  ...
  },
  {
    ...
    image: salmon,
    description: 'Delicious oven-baked salmon with a lemon and dill seasoning.',
  },
];
    ...
    >
      ...
      <div className="bg-black bg-opacity-50 flex flex-col flex-grow">
          ...
          <div className="container mx-auto flex justify-between items-center">
            ...
            <nav>
              <ul className="flex space-x-4">
                <li><Link to="/lobby" className="text-white-300 hover:text-teal-500">Lobby</Link></li>
                <li><a href="/" onClick={handleLogout} className="text-white-300 hover:text-teal-500">Logout</a></li>
              </ul>
            </nav>
          </div>
        </header>
        ...
        <main className="flex-grow flex flex-col items-center py-8">
          <h1 className="text-4xl font-bold text-white mb-6">Healthy Meals</h1>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
            {recipes.map((recipe) => (
              <div key={recipe.id} className="bg-white rounded-lg shadow-md overflow-hidden border border-green-500">
                <img src={recipe.image} alt={recipe.name} className="w-full h-48 object-cover" />
                <div className="p-4">
                  <h2 className="text-xl font-bold text-teal-500">{recipe.name}</h2>
