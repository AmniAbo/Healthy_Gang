...
const sports = [
    {
      ...
      description: 'A great way to build endurance and agility while having fun.',
    },
    {
      id: 2,
      name: 'Yoga',
    ...
    },
    {
      ...
      name: 'Running',
      image: runningImage,
      description: 'Improves cardiovascular health and burns calories.',
    },
    {
      id: 4,
      name: 'Cycling',
      image: cyclingImage,
      description: 'Builds muscle and improves heart health.',
    },
    {
      id: 5,
      name: 'Swimming',
    ...
    },
    {
      ...
      name: 'Hiking',
      image: hikingImage,
      description: 'Great for building leg strength and enjoying nature.',
    },
    {
      id: 7,
      name: 'Tennis',
      image: tennisImage,
      description: 'Enhances hand-eye coordination and cardiovascular fitness.',
    },
    {
      id: 8,
      name: 'Soccer',
      image: soccerImage,
      description: 'Improves endurance and teamwork skills.',
    },
    {
      id: 9,
      name: 'Weightlifting',
      image: weightliftingImage,
      description: 'Builds muscle strength and bone density.',
    },
    {
      id: 10,
      name: 'Pilates',
      image: pilatesImage,
      description: 'Improves core strength and flexibility.',
    },
  ];
    ...
    >
      ...
      <div className="bg-black bg-opacity-50 flex flex-col flex-grow">
        ...
        <main className="flex-grow flex flex-col items-center py-8">
          <h1 className="text-4xl font-bold text-white mb-6">Healthy Sports</h1>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
            {sports.map((sport) => (
              <div key={sport.id} className="bg-white rounded-lg shadow-md overflow-hidden border border-green-500">
                <img src={sport.image} alt={sport.name} className="w-full h-48 object-cover" />
                <div className="p-4">
                  <h2 className="text-xl font-bold text-teal-500">{sport.name}</h2>
